...
{ //34
	...
	{
		{0, 960, 540, 0, 0, {0,0,960,540}},
		{0, 960*0.95, 540*0.95, 0, 0, {960,540*0.05,960*0.95,540}},
		1, 1,
	},
	1, "960x540.bmp"
},
...
{ //37
	...
	{
		{0, 960, 540, 0, 0, {0,0,960,540}},
		{0, 960*0.9, 540*0.9, 0, 0, {960*0.1,540,960,540*0.9}},
		1, 1,
	},
	1, "960x540.bmp"
},
...
{ //40
	...
	{
		{0, 960, 540, 0, 0, {0,0,960,540}},
		{0, 960*0.95, 540*0.95, 0, 0, {960*0.05,540,960,540*0.95}},
		1, 1,
	},
	1, "960x540.bmp"
},
...
{ //43
	...
	{
		{0, 960, 540, 0, 0, {0,0,960,540}},
		{0, 960*0.9, 540*0.9, 0, 0, {960,540*0.1,960*0.9,540}},
		1, 1,
	},
	1, "960x540.bmp"
},
...
{ //48
	...
	{
		{0, 800, 600, 0, 0, {0,0,800,600}},
		{0, 800*0.95, 600*0.95, 0, 0, {800,600*0.05,800*0.95,600}},
		1, 1,
	},
	1, "800x600_1.bmp"
},
{ //49
	...
	{
		{0, 800, 600, 0, 0, {0,0,800,600}},
		{0, 800*0.9, 600*0.9, 0, 0, {800*0.1,600,800,600*0.9}},
		1, 1,
	},
	1, "800x600_1.bmp"
},
{ //50
	...
	{
		{0, 800, 600, 0, 0, {0,0,800,600}},
		{0, 800*0.95, 600*0.95, 0, 0, {800*0.05,600,800,600*0.95}},
		1, 1,
	},
	1, "800x600_1.bmp"
},
{ //51
	...
	{
		{0, 800, 600, 0, 0, {0,0,800,600}},
		{0, 800*0.9, 600*0.9, 0, 0, {800,600*0.1,800*0.9,600}},
		1, 1,
	},
	1, "800x600_1.bmp"
},
...
{ //65
	...
	{
		{0, 720, 480, 0, 0, {0,0,720,480}},
		{0, 720*0.95, 480*0.95, 0, 0, {720,480*0.05,720*0.95,480}},
		1, 1,
	},
	1, "720x480_Y_UV20.yuv"
},
...
{ //68
	...
	{
		{0, 720, 480, 0, 0, {0,0,720,480}},
		{0, 720*0.9, 480*0.9, 0, 0, {720*0.1,480,720,480*0.9}},
		1, 1,
	},
	1, "720x480_Y_UV20.yuv"
},
...
{ //71
	...
	{
		{0, 720, 480, 0, 0, {0,0,720,480}},
		{0, 720*0.95, 480*0.95, 0, 0, {720*0.05,480,720,480*0.95}},
		1, 1,
	},
	1, "720x480_Y_UV20.yuv"
},
...
{ //74
	...
	{
		{0, 720, 480, 0, 0, {0,0,720,480}},
		{0, 720*0.9, 480*0.9, 0, 0, {720,480*0.1,720*0.9,480}},
		1, 1,
	},
	1, "720x480_Y_UV20.yuv"
},
